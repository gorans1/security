...
################################################################################
"""
This script creates application profile in the pod# (i.e. pod1) tenant, whose
EPGs will be used to create service graphs with ASA firewall.       
"""
...
for x in range(pod_num_start, (1 + pod_num_end)):
    ...
    fvRsBd = cobra.model.fv.RsBd(fvAEPg, tnFvBDName=u'app')
