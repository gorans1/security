...
################################################################################
"""
Script create a function profile for L4-7 device, ASA contexts to reside in a
service graph beteen app and db EPGs.  Configuration includes ASA IP addresses
and access-list applied on inbound traffic.
"""
'''
...
for pod_num in range(pod_num_start, (1 + pod_num_end)):
    ...
    vnsAbsFuncProfGrp = cobra.model.vns.AbsFuncProfGrp(vnsAbsFuncProfContr, ownerKey=u'', name=u'asa-fail-gr', descr=u'', ownerTag=u'')
    vnsAbsFuncProf = cobra.model.vns.AbsFuncProf(vnsAbsFuncProfGrp, ownerKey=u'', name=u'asa-fail-fprof', descr=u'', ownerTag=u'')
    ...
    vnsAbsParam28 = cobra.model.vns.AbsParam(vnsAbsFolder25, validation=u'', mandatory=u'yes', name=u'ipv4_address', value=u'10.1.0.1/255.255.255.0', key=u'ipv4_address', locked=u'no', cardinality=u'unspecified')
