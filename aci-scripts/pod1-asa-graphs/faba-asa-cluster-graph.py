...
for pod_num in range(pod_num_start, (1 + pod_num_end)):
    ...
    vnsAbsGraph = cobra.model.vns.AbsGraph(fvTenant, ownerKey=u'', name=u'asa-clu-graph', descr=u'', ownerTag=u'', uiTemplateType=u'UNSPECIFIED')
    ...
    vnsRsAbsConnectionConns = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection, tDn=u'uni/tn-pod%s/AbsGraph-asa-clu-graph/AbsNode-FIREWALL/AbsFConn-consumer'  % pod_num)

    vnsRsAbsConnectionConns2 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection, tDn=u'uni/tn-pod%s/AbsGraph-asa-clu-graph/AbsTermNodeCon-T1/AbsTConn'  % pod_num)
    ...
    vnsRsAbsConnectionConns3 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection2, tDn=u'uni/tn-pod%s/AbsGraph-asa-clu-graph/AbsTermNodeProv-T2/AbsTConn'  % pod_num)
    vnsRsAbsConnectionConns4 = cobra.model.vns.RsAbsConnectionConns(vnsAbsConnection2, tDn=u'uni/tn-pod%s/AbsGraph-asa-clu-graph/AbsNode-FIREWALL/AbsFConn-provider'  % pod_num)
    ...
    vnsRsNodeToAbsFuncProf = cobra.model.vns.RsNodeToAbsFuncProf(vnsAbsNode, tDn=u'uni/tn-pod%s/absFuncProfContr/absFuncProfGrp-asa-clu-gr/absFuncProf-asa-clu-fprof'  % pod_num)
    vnsRsNodeToMFunc = cobra.model.vns.RsNodeToMFunc(vnsAbsNode, tDn=u'uni/infra/mDev-CISCO-ASA-1.2/mFunc-Firewall')
    vnsRsNodeToLDev = cobra.model.vns.RsNodeToLDev(vnsAbsNode, tDn=u'uni/tn-pod%s/lDevVip-pod%s-asa-clu' % (pod_num,pod_num))
